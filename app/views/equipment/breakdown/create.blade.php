			...
			<h1 class="panel-title" style="text-align:center">{{ HTML::image(Config::get('kblis.organization-logo'),  Config::get('kblis.country') . trans('messages.court-of-arms'), array('width' => '150px')) }}
				...
				<div class="panel panel-warning">
					...
					<div class="form-group">
						...
						{{ Form::text('report_date', Input::old('report_date'), array('class' => 'form-control col-sm-4 standard-datepicker report_date','required'=>'required')) }}
					</div>
				</div>
				...
				<div class="panel panel-warning">
					...
					<div class="form-group">
						...
						{{ Form::text('verification_date', Input::old('verification_date'), array('class' => 'form-control standard-datepicker' verification_date','required'=>'required')) }}
					</div>
